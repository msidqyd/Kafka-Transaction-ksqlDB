...
help:
	...
	@echo "  make run-transaction_producer-create    Run kafka/transaction_producer.py.py"
	@echo "  make run-protobuf-read      Run kafka/protobuf_read.py"
	@echo "  make run-size-comparison    Run kafka/size-comparison.py"

run-transaction_producer-create:
	python $(KAFKA_DIR)/transaction_producer.py

run-protobuf-read:
	python $(KAFKA_DIR)/protobuf_read.py

run-size-comparison:
	python $(KAFKA_DIR)/size-comparison.py
